(function($) {
    ...
    $(function () {
        ...
        gradientFill.addColorStop(0, "#ace8ef");
        gradientFill.addColorStop(1, "#ace8ef1a");
        ...
        $('.spark-bar-1').sparkline('html', {type: 'bar', barColor: '#68CBD7',height: '40',barWidth: 3,barSpacing: 3,});
        $('.spark-bar-2').sparkline('html', {type: 'bar', barColor: '#68CBD7',height: '40',barWidth: 3,barSpacing: 3,});
        // 2nd Highlighted Card  //
    });
})(jQuery);