(function($) {
    ...
    $(function () {
        ...
        gradientFill.addColorStop(0, "#5b82b1");
        ...
        $('.spark-bar-1').sparkline('html', {type: 'bar', barColor: '#1627D3',height: '40',barWidth: 3,barSpacing: 3,});
        $('.spark-bar-2').sparkline('html', {type: 'bar', barColor: '#1627D3',height: '40',barWidth: 3,barSpacing: 3,});
        // 2nd Highlighted Card  //
    });
})(jQuery);