(function($) {
    ...
    $(function () {
        ...
        $('#map-world').vectorMap('set', 'colors', { au: '#abadb1', us: '#abadb1', in: '#1627D3', cn:"#dcdee4", ca: '#dcdee4', gb:"#dcdee4"});
        // WorldMap Ends //
        ...
        // Events Perfect Scroll Starts //
        $(".widget-10-body").css({"overflow":"hidden","max-height": "458px", "position": "relative", "margin":"0 0 1.5rem 0"});
        var ps = new PerfectScrollbar(".widget-10-body",{
            wheelPropagation: false,
        });
        // Events Perfect Scroll Ends //

        // Timeline - Perfect Scroll Starts //
        $(".timeline-container").css({"height":"452px", "position": "relative"});
        var ps = new PerfectScrollbar(".timeline-container");
        // Timeline - Perfect Scroll Ends //

        // Project Assets - Perfect Scroll Starts //
        $(".widget-11-files").css({"overflow":"hidden","max-height": "453px", "position": "relative"});
        var ps = new PerfectScrollbar('.widget-11-files');
        // Project Assets - Perfect Scroll Ends //
