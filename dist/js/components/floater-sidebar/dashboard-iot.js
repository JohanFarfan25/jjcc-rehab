(function($) {
    ...
    $(function () {
        ...
        gradientFill.addColorStop(0, "#c7eeff");
        gradientFill.addColorStop(1, "#c7eeff1a");
        ...
        $('.spark-bar-1').sparkline('html', {type: 'bar', barColor: '#22b9ff',height: '40',barWidth: 3,barSpacing: 3,});
        $('.spark-bar-2').sparkline('html', {type: 'bar', barColor: '#22b9ff',height: '40',barWidth: 3,barSpacing: 3,});
        // 2nd Highlighted Card  //
    });
})(jQuery);