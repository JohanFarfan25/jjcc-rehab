(function($) {
    ...
    $(function () {
        ...
        gradientFill.addColorStop(0, "#a380e8");
        gradientFill.addColorStop(1, "#a380e81a");
        ...
        $('.spark-bar-1').sparkline('html', {type: 'bar', barColor: '#6724D4',height: '40',barWidth: 3,barSpacing: 3,});
        $('.spark-bar-2').sparkline('html', {type: 'bar', barColor: '#6724D4',height: '40',barWidth: 3,barSpacing: 3,});
        // 2nd Highlighted Card  //
    });
})(jQuery);